  ...
  return <div className="page case-detail-page">
    ...
    <div className="detail-grid">
      <div className="detail-main">
        ...
        <section className="panel progress-panel"><div className="section-title"><h2>回付ルートと進捗</h2>{canEdit && <button className="secondary-button" onClick={() => setEditingRoute(true)}>未処理ルートを編集</button>}</div>
